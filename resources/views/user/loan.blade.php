                        ...
                        <div class="card">
                            <div class="card-header">
                                <p><span class="text-primary">Your home journey starts here.</span> Let
                                    Hay Stack Pays be your partner
                                </p>
                                <p></p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <img src="https://haystackpays.com/themes/finapp-light/images/happyhome.png"
                                            width="100%" />
                                    </div>
                                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <img src="https://haystackpays.com/themes/finapp-light/images/mortgage.png"
                                            width="100%" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="detail"> <span
                                    ...
                                    <div> <strong>Auto Save</strong>
                                        <p>Set a goal, save automatically with
                                            Hay Stack Pays's Auto Save and track your progress.
                                        </p>
                                    </div>
                                </div>
                            </a>
